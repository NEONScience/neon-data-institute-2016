...
<figure class="half">
	...
	<figcaption>LEFTS: You will fork and clone a repo <strong> once </strong>. RIGHT: After you have forked
	...
	similar but the commands are different!
...
1. Update fork from the central repository (Pull Request)
2. Update local copy from your fork (`git pull`)
3. Push changes from local to your fork (`git push`)
4. Update the central repository from your fork (Pull Request)
...
In the last tutorial, we taught you to push your edits immediately after committing changes, 
...
it was originally forked. This message does not show up on non-forked (central) repos.
...
This message tells us that this particular fork, which is located in the `mjones01/`
account, is **behind** the central institute participants repository from which 
it was forked.

**What this means:** If your repo is **behind** another repo, it means that
...
of the central repo, it is important to ensure that your fork is up to date with
all changes in the central repo.
...
which both have changes, you need two pull requests.
...
Select your fork to compare with NEON central repo. Here we want to add any changes
in the **NEON-WorkWithData/DI16-NEON-participants** repo to your fork. 
...
<figure>
 <a href="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/git-push-pull-flow.png">
 <img src="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/git-push-pull-flow.png"></a>
 <figcaption>Once you have forked and cloned a repo, then you are ready to work
 on the project. You will use "Pull" to pull new changes down from your fork,
 to your local cloned copy of the repo. And you will "Push" those changes back
 up to your fork on github.com.
 Source: National Ecological Observatory Network (NEON) </a>
 </figcaption>
</figure>
