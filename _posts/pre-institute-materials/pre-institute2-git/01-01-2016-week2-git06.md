...
<figure class="half">
 ...
 <img src="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/Fork_graphic.png" width="70%"></a>
 ...
 <figcaption>You will fork and clone a repo ONCE. RIGHT: After you have forked
 and cloned a repo, you will update your fork from the Central Repository using
 a PULL REQUEST. You will update your local copy of the repo (on your laptop)
 using Git PULL. Notice that the workflow is similar but the commands are different!
...
<figure>
 ...
 <img src="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/git-push-pr.png" width="70%"></a>
 <figcaption>To sync changes made and COMMITTED to the repo from your local computer,
 you will first PUSH the changes from your local repo to your fork on github.com.
 Then, you will submit a PULL REQUEST to update the central repository.
 Source: National Ecological Observatory Network (NEON) </a>
 </figcaption>
</figure>
