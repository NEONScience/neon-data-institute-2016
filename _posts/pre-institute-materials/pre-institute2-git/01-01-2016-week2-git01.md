...
4. When you are ready to submit your changes to the NEON repository, you will:
   * Sync your local copy of the institute repository with NEON's central 
repository by copying any changes that have occurred in the central repository.
...
repository using the same workflow!  
 ...
 <figure>
	...
	request. We will be walking through the steps of this workflow over the
	next few lessons.
