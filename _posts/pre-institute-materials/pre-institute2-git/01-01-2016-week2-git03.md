...
<figure>
 ...
 <figcaption>When you fork a repo on the github.com website, you are creating a
...
<figure>
 <a href="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/#.png">
 <img src="{{ site.baseurl }}/images/pre-institute-content/pre-institute2-git/#.png"></a>
 <figcaption>When you clone a (forked) repo to your local computer, you are creating a
 COPY of that same repo you forked  LOCALLY on your laptop (or desktop). This
 allows you to edit files on your computer. And ofcourse, it is also yet another
