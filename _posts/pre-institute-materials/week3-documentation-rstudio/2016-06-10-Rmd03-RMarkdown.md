...
Prior to beginning this content you will need to have RMarkdown and the knitr package installed prior to completing this tutorial. If you do not, please refer back to <a href =” “ target=”_blank”> the setup materials</a>. 
...
this week’s activity and the Data Institute. 
...
ADD
Our goal in week 3 is to create an documented html file that shows our 
analysis workflow so let’s use HTML.
...
GRAPHIC:NewRmd-html-screenshot.png 
...
environment and reading in the data.
    ...
    ## Error in setwd("working-dir-path-here"): cannot change working directory
...
2. Run the code. This can be done several ways:
