...
## End Products 
This checklist includes what needs to be set-up on your computer for the 
...
Once R and RStudio are installed (installation instruction above), open RStudio 
to make sure it works and you don’t get any error messages. Then install the 
needed R packages. 
