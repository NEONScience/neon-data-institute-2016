...
will need to implement this project. You will have time over the next few weeks
to refine your idea.

The goal of this activity if for you to begin to think about the project that you
wish to work on, while at the Data Institute. Note: this project will be ideally
performed in groups so you can collaborate with your colleagues.
</div>
