...
To begin, please read the following pages about NEON's Mission & Design:
...
Then, watch the overview videos below.
...
Watch the XX minute video to better understand NEON's design.
...
1. Aquatic vs terrestrial field sites.
2. Core vs relocatable field sites.
...
<i class="fa fa-star"></i> Note: NEON also provides to support your own research including
...
will need to implement this project. You will have time
over the next few weeks to refine your idea, the goal here is to  
start thinking of a project you would like to work on.
</div>
