...
you took to classify the raster in R and to "analyze" or describe the outputs. 
Do they tell you anything about vegetation structure at the field site?

When you are done, add to this markdown document. Create the following threshold 
classified outputs:

1. A raster where NDVI values are classified into categories 0 (low greenness, 
