...
dsm <- raster("teak_5May2016/lidar/Teak_lidarDSM.tif")
# dtm = digital terrain model = elevation
dtm <- raster("teak_5May2016/lidar/Teak_lidarDTM.tif") 

# rename to CHM
# chm <- dsm - dtm
chm <- raster("teak_5May2016/lidar/Teak_lidarCHM.tif")
...
f <- "teak_5May2016/spectrometer/Subset3NIS1_20130614_100459_atmcor.h5"
...
aspect <- raster("teak_5May2016/lidar/Teak_lidarAspect.tif")
...
### I'm not getting any NDVIs more than 1...? If you do, thought, I would just set
### those to NA, since that's a sign of some sort of processing issue...
...
### I think this is ok - see comment below.
