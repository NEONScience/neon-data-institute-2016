...
How many bands does our data contains?
...
Once we know the dimensions of the data, we can more efficient **slice** out
...
Finally, we may want to export our new raster to a GTIF format.
